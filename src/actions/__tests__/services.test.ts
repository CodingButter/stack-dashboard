...
const EXPECTED: Record<string, [BlastRadius, Role]> = {
  ...
  "sab.pause-queue": ["safe", "viewer"],
  "sab.resume-queue": ["safe", "viewer"],
  "sab.pause-job": ["safe", "viewer"],
  "sab.resume-job": ["safe", "viewer"],
  "sab.delete-job": ["destructive", "admin"],
  "sab.set-priority": ["safe", "viewer"],
  "sab.set-speedlimit": ["disruptive", "admin"],
  "sab.retry-failed": ["safe", "viewer"],
  "qbit.pause-all": ["safe", "viewer"],
  "qbit.resume-all": ["safe", "viewer"],
  "qbit.pause-torrent": ["safe", "viewer"],
  "qbit.resume-torrent": ["safe", "viewer"],
  "qbit.delete-torrent": ["destructive", "admin"],
  "qbit.recheck-torrent": ["safe", "viewer"],
  "qbit.reannounce-torrent": ["safe", "viewer"],
  "qbit.set-category": ["safe", "viewer"],
  ...
  "sonarr.toggle-monitored": ["safe", "viewer"],
  ...
  "radarr.toggle-monitored": ["safe", "viewer"],
  ...
  "tdarr.pause-node": ["safe", "viewer"],
  "tdarr.resume-node": ["safe", "viewer"],
  "tdarr.pause-all-nodes": ["safe", "viewer"],
